...
3. Now that you have npm, you'll need to run `npm install mysql` and `npm install express` so that you have all the dependencies we need to get our server up and running
4. 