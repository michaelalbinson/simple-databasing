...
3. Now that you have npm, you'll need to run `npm install mysql`, `npm install client-session` and `npm install express` so that you have all the dependencies we need to get our server up and running
